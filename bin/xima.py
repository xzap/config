...
ximalaya_down = os.path.realpath('/tmp/ximalaya.down') 
if os.path.exists(ximalaya_down):
	os.remove(ximalaya_down)
...
path = os.path.realpath("/data/ximalaya")
...
''' % (mp3url,dpath,filename)
    # print (cc)
		with open (ximalaya_down,'a') as  x :
			x.write(cc)
		global ok
		ok += 1
		print()
...
urllist = [
'http://www.ximalaya.com/#/1000202/album/238474',
'http://www.ximalaya.com/#/1000202/album/267720',
'http://www.ximalaya.com/#/1000202/album/276111',
]
