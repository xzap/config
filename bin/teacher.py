...
(("10:15","10:55","信息","301","上午第三节"),("13:35","14:15","信息","405","下午第二节"),("14:25","15:05","信息","305","下午第三节")),
(("10:15","10:55","信息","306","上午第三节"),("12:40","13:20","信息","403","下午第一节"),("13:35","14:15","信息","406","下午第二节")),
(("10:15","10:55","信息","401","上午第三节"),),
(("12:40","13:20","信息","304","下午第一节"),("13:35","14:15","信息","404","下午第二节"),("14:25","15:05","信息","402","下午第三节")),
(("12:40","13:20","信息","302","下午第一节"),("13:35","14:15","信息","303","下午第二节"))
)
...
for i in range(t,t+7):
	...
	if i<5 :
		...
		if i==2 and c==0 and l<6: print("${color green}值日$color")
		ccc = 0
		for j in all[i] :
			if i==t :
				ti = j[0].split(":")
				...
				if atime > btime and ccc == 0:
					ccc =1
					print ("${color green}"+j[4],j[0]+"-"+j[1],"${alignr}"+j[3],j[2]+"$color")
				else :
